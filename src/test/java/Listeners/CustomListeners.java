 ...
 * 
 * import org.testng.ISuite; import org.testng.ISuiteListener; import
 ...
 * com.w2a.utilities.ExtentManager; import com.w2a.utilities.TestUtil;
 * 
 * import Utilities.MonitoringMail; import Utilities.TestConfig; import
 * Z_Base.Base_Agent;
 * 
 * public class CustomListeners extends Base_Agent implements
 * ITestListener,ISuiteListener {
 * 
 * static Date d = new Date(); static String fileName = "Extent_" +
 * d.toString().replace(":", "_").replace(" ", "_") + ".html"; static String
 * messageBody; private static ExtentReports extent =
 * ExtentManager.createInstance(System.getProperty("user.dir")+"\\reports\\"+
 * fileName); public static ThreadLocal<ExtentTest> testReport = new
 ...
 * Arrays.toString(result.getThrowable().getStackTrace()); testReport.get()
 ...
 * 
 * 
 * public void onTestSkipped(ITestResult result) { String
 * methodName=result.getMethod().getMethodName(); String
 ...
 * ":8080/job/ASV/Extent_20Reports/";; } catch (UnknownHostException e) { //
